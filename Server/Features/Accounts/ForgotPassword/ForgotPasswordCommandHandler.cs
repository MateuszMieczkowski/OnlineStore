...
public class ForgotPasswordCommandHandler : ICommandHandler<Shared.Accounts.ForgotPassword>
{
    ...
    public async Task Handle(Shared.Accounts.ForgotPassword command, CancellationToken cancellationToken = default)
    {
